...
public partial class Page1
{
    ...
    //    pacmanImage.ImageSource = new BitmapImage(new Uri("pack://application:,,,/img/pacman.jpg"));
    //    pacman.Fill = pacmanImage;
    //    //ImageBrush redGhost = new ImageBrush();
    //    //redGhost.ImageSource = new BitmapImage(new Uri("pack://application:,,,/NewFolder1/red.jpg"));
    //    //redGuy.Fill = redGhost;
    //    ImageBrush orangeGhost = new ImageBrush();
    //    orangeGhost.ImageSource = new BitmapImage(new Uri("pack://application:,,,/img/orange.jpg"));
    //    orangeGuy.Fill = orangeGhost;
    //    ImageBrush pinkGhost = new ImageBrush();
    //    pinkGhost.ImageSource = new BitmapImage(new Uri("pack://application:,,,/img/pink.jpg"));
    ...
    private new void CanvasKeyDown(object sender, KeyEventArgs e)
    {
        base.CanvasKeyDown(sender, e);
    }

    private new void CanvasKeyUp(object sender, KeyEventArgs e)
    {
        base.CanvasKeyUp(sender, e);
    }
}
